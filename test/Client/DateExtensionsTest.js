...
import {atMidnight, daysInMonth, getEaster, getWeekOfYear, inLeapYear, isHoliday, isWorkingDay, toIsoWeek, toYmdHms} from "@cedx/base/Date.js";
...
describe("Date utilities", () => {
	...
	describe("toYmdHms()", () => {
		...
		it("should format the given date as 'YYYY-MM-DD'", () =>
			equal(toYmdHms(new Date("2024-03-01 12:58:18"), {excludeTime: true}), "2024-03-01"));

		it("should format the given date as 'HH:MM:SS'", () =>
			equal(toYmdHms(new Date("2024-03-01 12:58:18"), {excludeDate: true}), "12:58:18"));
	});
});
